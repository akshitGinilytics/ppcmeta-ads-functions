...
async function getCampaignList(customerInstance, campaignIds) {
    const constraints = [
        {
            key: "campaign.status",
            op: "IN",
...
async function getCampaignsCostAverage(customerInstance, customerTimezone, campaignIds, xDays = 3) {
    const constraints = [
        {
            key: "campaign.status",
            op: "IN",
