...
export default class UserDataLoaders {
    ...
    async batchUserCustomers(customersIds) {
    ...
    async batchUserCampaigns(campaignIds) {
        ...
        const campaigns = mapper(campaignsSnapshot, campaignIds.map(id => id.split("/")[1]));
    ...
    async getUserCustomerCampaigns(customerId) {
