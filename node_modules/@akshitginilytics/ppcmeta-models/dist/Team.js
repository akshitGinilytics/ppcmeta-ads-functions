...
export default class Team {
    ...
    campaignsByCustomer;
    campaignsCount;
    constructor(dataLoaders, teamId) {
        this._teamId = teamId;
    ...
    static async createTeam(teamName, ownerUser, permission) {
        const teamMember = {
            id: ownerUser.userId,
    ...
    async checkIfCustomersAreNotPartOfAnotherTeam(customers) {
    ...
    async getCustomersById(customerIds) {
        ...
        return customers.filter(customer => customer instanceof TeamCustomer && customer.teamId == this.teamId);
    }
    ...
    static async getTeamById(dataloader, teamId) {
        const team = new Team(dataloader, teamId);
        return await team.getTeam();
    }
    async addMember(user, role = "viewer") {
        await user.getUser();
    ...
    async addCampaigns(campaigns) {
        return TeamCustomer.addCampaigns(this, campaigns);
    }
    async removeCampaigns(campaignsByCustomer) {
