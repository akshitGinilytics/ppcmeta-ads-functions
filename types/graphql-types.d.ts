...
export type CampaignSettings = {
  ...
  thisMonthBudget?: Maybe<Scalars['Float']>;
};
...
export type Me = {
  ...
  defaultTeam: Scalars['String'];
  displayName: Scalars['String'];
  email: Scalars['String'];
  hasGoogleAdsAccount: Scalars['Boolean'];
...
export type Metrics = {
  __typename?: 'Metrics';
  allConversions: Scalars['Float'];
  averageCPC: Scalars['Float'];
  clicks: Scalars['Int'];
  costMicros: Scalars['Float'];
  impressions: Scalars['Int'];
  xDaysAverageCost: Scalars['Float'];
};

export type MonthlyBudgetInput = {
  campaignId: Scalars['String'];
  thisMonthBudget: Scalars['Float'];
};
...
export type Mutation = {
  ...
  removeCampaigns?: Maybe<Scalars['String']>;
  removeCustomers?: Maybe<Scalars['String']>;
  renameTeam: Scalars['String'];
  sendInvite?: Maybe<Invite>;
  setMonthlyBudget: Scalars['Boolean'];
  setTeam: Scalars['String'];
};
...
export type MutationRemoveCustomersArgs = {
  customersIds: Array<Scalars['String']>;
};
...
export type QueryGoogleAdsCustomersArgs = {
  customerIds?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
};
...
export type RemoveCampaignInput = {
  campaignsIds: Array<Scalars['String']>;
  customerId: Scalars['ID'];
};
